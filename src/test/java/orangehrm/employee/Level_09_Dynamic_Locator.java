...
public class Level_09_Dynamic_Locator extends BaseTest {
    ...
    @Test
    public void Employee_02_Switch_Page_01() {
        // Personal --> Contact Detail
        contactDetailPage = (ContactDetailPO) personalDetailPage.openMyInfoPageByName("Contact Details");

        // Contact --> Job
        jobPage = (JobPO) contactDetailPage.openMyInfoPageByName("Job");

        // Job --> Dependent
        dependentPage = (DependentPO) jobPage.openMyInfoPageByName("Dependent");

        // Dependent --> Personal
        personalDetailPage = (PersonalDetailPO) dependentPage.openMyInfoPageByName("Personal Details");
    ...
    @Test
    public void Employee_02_Switch_Page_02() {

        // Contact --> Job
        contactDetailPage.openMyInfoPageByPageName("Job");
        jobPage = PageGeneration.getPage(JobPO.class, driver);

        // Job --> Dependent
        jobPage.openMyInfoPageByPageName("Dependent");
        dependentPage = PageGeneration.getPage(DependentPO.class, driver);

        // Dependent --> Personal
        dependentPage.openMyInfoPageByPageName("Personal Details");
        personalDetailPage = PageGeneration.getPage(PersonalDetailPO.class, driver);

        // Personal --> Contact Details
        personalDetailPage.openMyInfoPageByPageName("Contact Details");
        contactDetailPage = PageGeneration.getPage(ContactDetailPO.class, driver);
