...
@Epic("")
@Feature("")
public class Level_18_ComponentPattern_I extends BaseTest {
...
//        loginPage.enterToPasswordTextbox(adminPassword);
        ...
        loginPage.enterToTextboxByName("username", adminUsername);
        loginPage.enterToTextboxByName("password", adminPassword);
        ...
        employeeListPage = PageGeneration.getPage(EmployeeListPO.class, driver);
    ...
    public void Employee_02_ViewEmployee() {
        ...
        employeeID = addEmployeePage.getTextboxValueByLabel("Employee Id");

        addEmployeePage.clickToCreateLoginDetailCheckbox();
        addEmployeePage.sleepInSecond(2);

        addEmployeePage.enterToTextboxByLabel("Username", emailAddress);
        addEmployeePage.enterToTextboxByLabel("Password", password);
        addEmployeePage.enterToTextboxByLabel("Confirm Password", password);
