...
public class Level_09_Page_URL_I extends BaseTest {
    ...
    public void Navigate_01_No_Logout(){
        ...
        adminManageCustomerPage.openOrderPage(driver);
    ...
    public void Navigate_02_Logout(){
        ...
        // log out khỏi trang user
        adminLoginPage = userMyAccountPage.logoutToAdminPage(driver);

        userHomePage = adminLoginPage.openUserPage(driver, userUrl);
